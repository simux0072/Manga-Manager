...
class V2Settings(BaseSettings):
    ...
    def pool_limits(self) -> dict[str, int]:
        return {
            ...
            "pull:mangafire": 1,
            "pull:kingofshojo": 1,
            "provider:asura": self.network_worker_concurrency,
            "provider:mangadex": self.network_worker_concurrency,
            "provider:mangafire": self.network_worker_concurrency,
            "provider:kingofshojo": self.network_worker_concurrency,
